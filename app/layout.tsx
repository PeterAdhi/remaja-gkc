...
import SplashScreen from './components/SplashScreen' // ⚠️ Sesuaikan path ini dengan lokasi file SplashScreen.tsx kamu
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="id">
      ...
      >
        {/* Splash Screen Animasi Awal — pakai komponen SplashScreen asli */}
        {showSplash && <SplashScreen onFinish={() => setShowSplash(false)} />}

        <div className={showSplash ? 'overflow-hidden h-screen' : ''}>
          {/* ================= NAVBAR ================= */}
          <nav
            className="sticky top-0 z-40 border-b relative overflow-hidden"
            style={{
              background:
